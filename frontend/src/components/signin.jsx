      ...
      <div className="absolute top-0 left-0 right-0 p-4">
        ...
        <div className="flex justify-between items-start w-full">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-600" style={{ fontFamily: 'Poppins, sans-serif' }}>Do not have an account?</span>
            <button 
        ...
        <div className="mt-16 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm" >
              <span className="px-2 bg-gray-50 text-gray-500" style={{background: 'linear-gradient(135deg, rgba(134, 250, 238, 0.6) 0%, rgba(135, 206, 250, 0.8) 100%)',
      }}>or</span>
            </div>
          </div>
